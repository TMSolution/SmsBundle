...
class UserFactory extends ActionFactory
{
    ...
    {
        $action = new \TMSolution\SmsBundle\Api\SMSApi\Api\Action\User\UserList();
    ...
    {
        $action = new \TMSolution\SmsBundle\Api\SMSApi\Api\Action\User\Add();
        $action->client($this->client);
        $action->proxy($this->proxy);
    ...
    {
        $action = new \TMSolution\SmsBundle\Api\SMSApi\Api\Action\User\Edit();
        $action->client($this->client);
        $action->proxy($this->proxy);
    ...
    {
        $action = new \TMSolution\SmsBundle\Api\SMSApi\Api\Action\User\Get();
        $action->client($this->client);
        $action->proxy($this->proxy);
    ...
    {
        $action = new \TMSolution\SmsBundle\Api\SMSApi\Api\Action\User\GetPoints();
        $action->client($this->client);
        $action->proxy($this->proxy);
